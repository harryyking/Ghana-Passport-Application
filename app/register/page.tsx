...
const adinkraSymbols = [
  { src: "/adinkra/adinkra1.png", alt: "Adinkra Symbol 1" },
  { src: "/adinkra/adinkra2.png", alt: "Adinkra Symbol 2" },
  { src: "/adinkra/adinkra3.png", alt: "Adinkra Symbol 3" },
  { src: "/adinkra/adinkra4.png", alt: "Adinkra Symbol 4" },
  { src: "/adinkra/adinkra5.png", alt: "Adinkra Symbol 5" },
]
...
export default function RegisterPage() {
  ...
  const handleGhanaCardChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (value.startsWith("GHA-") && value.length <= 14) {
      ...
      setError("Ghana Card number must start with GHA- and be 14 characters long")
    }
  }

  const handleRegister = async (e: React.FormEvent) => {
    e.preventDefault()
    if (ghanaCardNumber.length !== 14) {
      setError("Ghana Card number must be 14 characters long")
      return
    }
